...
The database is Postgres with pgvector. Large files, models, WhatsApp stores, media, logs, and backups live under `/Volumes/Arya 1TB/VijiAI`. The default storage allocation is `large-200gb`.
