...
| Phase 24 | Complete | Hybrid lexical plus semantic resource retrieval with pgvector |
...
- Dashboard runtime visibility for semantic file matching settings.
...
```bash
node --test tests/migrations/phase1-migrations.test.mjs
node --test tests/resources/phase24-semantic-retrieval.test.mjs
```
