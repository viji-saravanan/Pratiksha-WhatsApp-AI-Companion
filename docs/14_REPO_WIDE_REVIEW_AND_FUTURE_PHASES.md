...
- Docker Desktop data is configured on the SSD at `/Volumes/Arya 1TB/VijiAI/DockerDesktop`.
...
- The remaining open review themes are Phase 20 through Phase 26: persistent adapter, automatic media persistence, image/document understanding, voice transcription, semantic retrieval, multi-contact copy cleanup, and evaluation gates.
...
- Keep new source and heavy runtime state under `/Volumes/Arya 1TB/VijiAI`.
